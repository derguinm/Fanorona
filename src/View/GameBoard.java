...
public class GameBoard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        rules_bg.setIcon(new javax.swing.ImageIcon("src/View/ressources/board_rules.png")); // NOI18N
        ...
        menu_cancel.setIcon(new javax.swing.ImageIcon(("src/View/ressources/back_big.png"))); // NOI18N
        ...
        menu_save.setIcon(new javax.swing.ImageIcon(("src/View/ressources/save.png"))); // NOI18N
        ...
        menu_restart.setIcon(new javax.swing.ImageIcon(("src/View/ressources/restart.png"))); // NOI18N
        ...
        menu_restart.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ...
                            int a = JOptionPane.showOptionDialog(frame, "Do you really want to restart the game ?","Restart",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
        ...
        menu_home.setIcon(new javax.swing.ImageIcon(("src/View/ressources/rules_home.png"))); // NOI18N
        ...
        menu_home.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ...
                            int a = JOptionPane.showOptionDialog(frame, "Do you want to save the game before going back home?","Warning!",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
                            if(a==JOptionPane.YES_OPTION){          
                                  //sauvgarde
                                game=new Jeu ();
                                reset_board(game);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(("src/View/ressources/board_bg_n.png"))); // NOI18N
        jPanel2.add(jLabel2);
        ...
        rules.setIcon(new javax.swing.ImageIcon("src/View/ressources/rules_title.png")); // NOI18N
        add(rules);
        ...
        cancel.setIcon(new javax.swing.ImageIcon(("src/View/ressources/cancel_turn.png"))); // NOI18N
        add(cancel);
        cancel.setBounds(230, 570, 50, 50);
        cancel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if(game.hi.taille_tete()==2){
                    game.getPlateau().iniPlateau();
                }else{
                    game=bp.Undo();
                }
                reset_board(game);
        ...
        redo.setIcon(new javax.swing.ImageIcon(("src/View/ressources/redo.png"))); // NOI18N
        add(redo);
        ...
        surrender.setIcon(new javax.swing.ImageIcon(("src/View/ressources/surrender.png"))); // NOI18N
        add(surrender);
        ...
        surrender.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                Object[] options = {"Yes","No "};
                            int a = JOptionPane.showOptionDialog(frame, "Do you really want to surrender ?","Surrender",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
                            if(a==JOptionPane.YES_OPTION){
                                //show winner
                            }
            }
        ...
        pause_menu.setIcon(new javax.swing.ImageIcon(("src/View/ressources/menu.png"))); // NOI18N
        ...
        curren_player.setIcon(new javax.swing.ImageIcon(("src/View/ressources/current_player.png"))); // NOI18N
        add(curren_player);
        curren_player.setBounds(290, 30, 250, 50);

        help.setIcon(new javax.swing.ImageIcon(("src/View/ressources/instruc.png"))); // NOI18N
        add(help);
        help.setBounds(120, 570, 50, 50);

        end_turn.setIcon(new javax.swing.ImageIcon(("src/View/ressources/end_turn.png"))); // NOI18N
        add(end_turn);
        ...
        game_board.setIcon(new javax.swing.ImageIcon(("src/View/ressources/board_bg.jpg"))); // NOI18N
        add(game_board);
        game_board.setBounds(0, 0, 800, 720);
    }// </editor-fold>        
    public void reset_board(Jeu game){
        menu_panel.setVisible(false);
