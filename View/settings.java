...
public class settings extends javax.swing.JPanel {
    ...
    public settings(JFrame f, JPanel menu, Jeu game) {
        ...
        starter.setSelectedIndex(Integer.parseInt(prop.getProperty("Initiator"))-1);
    ...
    private void initComponents() {
        ...
        starterlabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/ressources/starter.png"))); // NOI18N
        add(starterlabel);
        starterlabel.setToolTipText("who's gonna play first ?");
        starterlabel.setBounds(170, 200, 250, 65);

        player2txt.setIcon(new javax.swing.ImageIcon(("View/ressources/yellow.png"))); // NOI18N
        add(player2txt);
        player2txt.setToolTipText("is yellow a human or an IA");
        player2txt.setBounds(170, 340, 250, 60);

        player1txt.setIcon(new javax.swing.ImageIcon(("View/ressources/black.png"))); // NOI18N
        add(player1txt);
        player1txt.setToolTipText("is black a human or IA");
        ...
        add(difficulty_txt);
        difficulty_txt.setToolTipText("what is the difficulty of the IA");
        ...
        Apply.setToolTipText("apply modification");
        Apply.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                try{
                    prop.setProperty("Initiator", String.valueOf(starter.getSelectedIndex()+1));
        ...
        add(cancel_par);
        cancel_par.setToolTipText("cancel modification");
