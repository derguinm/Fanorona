...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(Jeu game, Coup strock, GameBoard gb) {
        ...
        try {
            InputStream stream = Configuration.charge("View/ressources/board_bg_n.png");
        ...
        if (mode == 1) {
            while (gameOver == 0) {
                if ( difficulty == 0 ){
                    ...
                    ia.min_max_globale(2,this);
                }
                else {
                    ia.min_max_globale(5,this);
                }
                endRound();
            }
        } else if (iaStarts == 1) {
    ...
    public void endRoundIA() {
        ...
        if (endRound() == true) {
            if ( difficulty == 0 ){
                ...
                IAList =  ia.min_max_globale(2,this);
            }
            else {
                IAList = ia.min_max_globale(5,this);
            }
            estCliquer = false;
            endRound();
        }
    ...
    public void winerclap(){
        try{
            InputStream audioSrc = getClass().getResourceAsStream("/View/ressources/win.wav");
